...
class BilstmCharRNNSequenceTagger(nn.Module):
    def __init__(self, num_labels, vocab_size, embedding_size=300, hidden_size = 256, intermediate_size = 128, embedding_init = None, char_list=string.ascii_letters):
        super(BilstmCharRNNSequenceTagger, self).__init__()
